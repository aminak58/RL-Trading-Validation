---
name: freqai-rl-optimizer
description: Professional skill for optimizing FreqAI Reinforcement Learning trading strategies, specifically designed for exit-focused RL models like MtfScalper_RL_Hybrid
---
